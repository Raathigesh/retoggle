...
function getRenderer(label, props) {
  ...
  switch (type) {
    case "boolean":
      return React__default.createElement(ToggleComponent, props);
    case "text":
      return React__default.createElement(TextComponent, props);
    case "number":
      return React__default.createElement(TextComponent$1, props);
    case "range":
      return React__default.createElement(ToggleComponent$1, props);
    case "select":
      return React__default.createElement(SelectComponent, props);
    case "timemachine":
      return React__default.createElement(TimeMachine, props);
    default:
      return null;
  }
}
...
function getRenderer$1(value) {
  if ((typeof value === "undefined" ? "undefined" : _typeof$1(value)) === "object") {
    return React__default.createElement(Inspector, { data: value });
...
function Logs() {
  ...
  return Object.values(logs).map(function (log) {
    return React__default.createElement(Log, log.props);
  });
}
...
function Inspector$1() {
  ...
  return ReactDOM.createPortal(React__default.createElement(
    ...
    React__default.createElement(
      Container$3,
      null,
      !isCollapsed && React__default.createElement(
        Content,
        null,
        React__default.createElement(Logs, null),
        React__default.createElement(Knobs, null)
      ),
      React__default.createElement(CollapseHandle, { title: "Collapse", onClick: handleExpandToggle })
    )
  ), mount());
}
...
function useTimeMachine(name, currentState) {
  var _useReducer = React.useReducer(function (machineState, action) {
    switch (action.type) {
      case "next":
        return {
...
exports.Inspector = Inspector$1;
exports.useLog = useLog;
exports.useBooleanKnob = useBooleanKnob;
exports.useTextKnob = useTextKnob;
exports.useNumberKnob = useTextKnob$1;
exports.useRangeKnob = useRangeKnob;
exports.useRangesKnob = useRangesKnob;
exports.useSelectKnob = useSelectKnob;
exports.useTimemachine = useTimeMachine;
