...
var UseLog = React__default.createContext({
  entries: {},
...
function LogItem(_ref) {
  ...
  var renderer = (typeof value === "undefined" ? "undefined" : _typeof$2(value)) === "object" ? React__default.createElement(Inspector, { data: value }) : value;
...
function Inspector$1(_ref) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      Container$1,
      null,
      React__default.createElement(CollapseHandle, { title: "Collapse" }),
      React__default.createElement(
        Content,
        null,
        Object.entries(useLogState.entries).map(function (_ref2) {
          ...
          return React__default.createElement(LogItem, { name: key, value: value });
        })
      )
    ),
    children
...
function useLog(name, value) {
  var context = React.useContext(UseLog);
...
function App() {
  var _useState = React.useState({ name: "" }),
      _useState2 = slicedToArray$2(_useState, 2),
      value = _useState2[0],
