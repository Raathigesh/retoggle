import React, { cloneElement, createContext, Component, createElement, useContext, useState, useEffect } from 'react';
...
var UseLog = React.createContext({
  entries: {},
...
var Name = styled.div(_templateObject2);
...
function LogItem(_ref) {
  ...
  var renderer = (typeof value === "undefined" ? "undefined" : _typeof$2(value)) === "object" ? React.createElement(Inspector, { data: value }) : value;
...
var CollapseHandle = styled.div(_templateObject2$1);

var Content = styled.div(_templateObject3$1);

function Inspector$1(_ref) {
  var children = _ref.children;

  var handleUpdate = function handleUpdate(name, value) {
    var newState = {
      entries: _extends$3({}, useLogState.entries, defineProperty$7({}, name, value)),
      update: handleUpdate
    };
  ...
  var _useState = useState({
    ...
    update: handleUpdate
      ...
      useLogState = _useState2[0],
      setLogState = _useState2[1];
  ...
  return React.createElement(
    ...
    React.createElement(
      Container$1,
      null,
      React.createElement(CollapseHandle, { title: "Collapse" }),
      React.createElement(
        Content,
        null,
        Object.entries(useLogState.entries).map(function (_ref2) {
          var _ref3 = slicedToArray$2(_ref2, 2),
              key = _ref3[0],
              value = _ref3[1];

          return React.createElement(LogItem, { name: key, value: value });
        })
      )
    ),
    children
